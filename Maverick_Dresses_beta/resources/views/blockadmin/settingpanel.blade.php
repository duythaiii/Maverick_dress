...
>
    ...
    <div class="flex flex-col h-screen">
        ...
        <div class="flex flex-col items-center justify-center flex-shrink-0 px-4 py-8 space-y-4 border-b dark:border-primary-dark">
            ...
            <h2 id="settinsPanelLabel" class="text-xl font-medium text-gray-500 dark:text-light">Cài Đặt</h2>
        </div>
        <!-- Content -->
        <div class="flex-1 overflow-hidden hover:overflow-y-auto">
            <!-- Theme -->
            <div class="p-4 space-y-4 md:p-8">
                <h6 class="text-lg font-medium text-gray-400 dark:text-light">Giao Diện</h6>
            ...
            <!-- Colors -->
            <div class="p-4 space-y-4 md:p-8">
                <h6 class="text-lg font-medium text-gray-400 dark:text-light">Màu</h6>
                <div>
